...
LANGUAGES = {
    "en": {
        ...
        "select_language": "Select the language for the app interface here.",
    ...
    "sk": {
        "title": "AID - Artificial Intelligence Dramaturge",
        "select_language": "Výber jazyka rozhrania aplikácie",
    ...
    "cs": {
  "title": "AID - Artificial Intelligence Dramaturge",
  "select_language": "Zvolte jazyk rozhraní aplikace",
  ...
  "reset_video": "Znovu zpracovat video",
